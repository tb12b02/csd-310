...
try:
    ...
    update_player = ("UPDATE player SET team_id = 2, first_name = 'Emerald', last_name = 'Cut' WHERE first_name = 'Platinum'")
    ...
    # delete query 
    delete_player = ("DELETE FROM player WHERE first_name = 'Emerald'")
